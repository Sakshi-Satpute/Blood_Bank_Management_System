...
class Register extends Component {
  ...
  parentHospitalValidation = (newErrors, parentHospital) => {
    ...
    if (parentHospital === "") {
      ...
      if (!(parentHospital.length >= 3 && parentHospital.length < 50)) {
        newErrors.parentHospital =
          "Length must be between 3 and 50 character !";
        flag = false;
      }
  ...
  handleSubmit = (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      console.log(bank);
      axios
        .post("http://localhost:7070/bank/register", bank)
        .then((response) => {
          console.log("componentDidMount");
          console.log(response);
          ...
          this.setState({ redirect: "/donorlogin" });
        })
        .catch((error) => {
          console.log(error);
        });
  ...
  componentDidMount() {
    if (this.state.statesdata.length === 0) {
      //http://localhost:7070/commondata/cities/39
      //axios.get('http://localhost:7070/commondata/allstates')
      commonService
        .getAllStates()
        .then((response) => {
          console.log("componentDidMount");
        ...
        <Form noValidate onSubmit={this.handleSubmit} autoComplete="off">
          <div className="row">
            ...
            <div className="col-md-6">
              <Form.Group
                className="m-2"
                controlId="formBasicParentHospitalName"
              >
                <Form.Label>Parent Hospital Name</Form.Label>
                <Form.Control
                  type="text"
                  placeholder="Enter Parent Hospital"
                  name="parentHospital"
                  onChange={this.parentHospitalNameHandler}
                  isValid={isValidPHName}
                  isInvalid={!!errors.parentHospital}
                  required
                />
                <Form.Control.Feedback>
                  <b>Looks good!</b>
            ...
            <div className="col-md-4">
              <Form.Group className="m-2" controlId="formBasicShortName">
                ...
                <Form.Control
                  ...
                  name="shortName"
                  onChange={this.shortNameHandler}
                  isValid={isValidShortName}
            ...
            <div className="col-md-4 ">
              <Form.Group className="m-2" controlId="formBasicLicence">
                ...
                <Form.Control
                  ...
                  name="licence"
                  onChange={this.licenceHandler}
                  isValid={isValidLicence}
            ...
            <div className="col-md-4">
              <Form.Group className="m-2" controlId="formBasicPersonName">
                ...
                <Form.Control
                  ...
                  name="personName"
                  onChange={this.personNameHandler}
                  isValid={isValidCPName}
            ...
            <div className="col-md-4 ">
              <Form.Group className="m-2" controlId="formGridComponentFacility">
                ...
                <Form.Select
                  className="col"
                  name="facility"
                  onChange={this.compFacilityHandler}
                  isValid={isValidCompFacility}
            ...
            <div className="col-md-4 ">
              <Form.Group className="m-2" controlId="formBasicMobile">
                ...
                <Form.Control
                  ...
                  name="beds"
                  onChange={this.bedsHandler}
                  isValid={isValidNoOfBeds}
